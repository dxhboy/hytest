export default {
  ...
  dashboard: {
    ...
    elementLocationDesc:
      "支持多种定位策略，包括ID、CSS Selector、XPath等，精确捕捉页面元素。",
    dualEngine: "双引擎驱动",
    dualEngineDesc: "支持Playwright+Selenium双引擎驱动",
    multiBrowser: "多浏览器运行",
    multiBrowserDesc:
      "可自由选择Chrome、Safari、Edge、Firefox在内的多款浏览器，支持有头、无头模式运行。",
    fullNotification: "全平台通知",
    fullNotificationDesc:
      "自由配置邮件、飞书、企微、钉钉在内的多种机器人通知，实现「躺在家」就能接收测试结果",
    scriptRecording: "脚本录制",
    scriptRecordingDesc:
      "提供可视化脚本录制功能，快速生成测试脚本，降低编码门槛。",
    autoExecution: "自动执行",
    autoExecutionDesc:
      "支持手动触发和定时执行，可集成CI/CD流程，实现持续测试。",
    // 时间格式
    justNow: "刚刚",
    minutesAgo: "{n}分钟前",
    hoursAgo: "{n}小时前",
  ...
  ai: {
    ...
    tip: "提示",
    tipContent1:
      'AI 模式使用"配置中心-AI智能模式配置"中的模型（如未添加模型，请前往添加）。',
  ...
  notification: {
    ...
    configs: {
      ...
      signatureSecretPlaceholder: "请输入机器人签名密钥（可选）",
      signatureSecretHint:
