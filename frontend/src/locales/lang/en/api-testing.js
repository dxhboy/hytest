...
export default {
  ...
  dashboard: {
    ...
    features: {
      interfaceManagement: {
        ...
        description:
          "Supports HTTP/HTTPS protocols, quick import of Swagger/Postman data for unified API management.",
      },
      automationTesting: {
        title: "Automation Testing",
        description:
          "Visual test flow orchestration with assertions, variable extraction, pre/post scripts and more.",
      },
      scheduledTask: {
        title: "Scheduled Tasks",
        description:
          "Flexible scheduled task configuration with Crontab expressions for unattended automated regression testing.",
      },
      multiDimensionalReport: {
        title: "Multi-dimensional Reports",
        description:
          "Generate detailed test reports with success rates, response time trends and multi-dimensional analysis.",
      },
    },
    timeFormat: {
      justNow: "Just now",
  ...
  interface: {
    ...
    selectInterface:
      "Select an interface to view details, or click the green button above to create a new one",
    ...
    deleteCollectionExtra:
      "Deleting a collection will also delete all interfaces within it.",
    ...
    method: "Method",
    clone: "Clone",
    cloneInterface: "Clone this interface (create a copy)",
    skipAuth: "No Token",
    skipAuthOff: "Current: Token attached (click to toggle)",
    skipAuthOn: "Current: No Token (click to toggle)",
    ...
    pasteCurlCommand:
      "Paste cURL command here, e.g.: curl -X POST https://api.example.com/users -H 'Content-Type: application/json' -d '{\"name\":\"test\"}'",
    ...
    assertionTypes: {
      ...
      equals: "Exact Match",
      mongoMatch: "Response Body Assertion (MongoDB Style)",
    },
    mongoMatchHint: "Supports MongoDB operators: $eq $ne $gt $gte $lt $lte $in $nin $exists $size $regex\nExample: {\"code\": \"0\", \"data\": {\"token\": {\"$exists\": true}}}",
    mongoTotal: "Total",
    mongoPassed: "Passed",
    mongoFailed: "Failed",
    ...
    contextMenu: {
      ...
      confirmBatchDelete: "Are you sure to delete {count} selected interface(s)?",
      batchDeleteSuccess: "Successfully deleted {count} interface(s)",
    },
    moveDialog: {
  ...
  history: {
    ...
    assertionResults: "Assertion Results",
    noAssertionData: "No assertion data",
    retryRequest: "Retry",
    confirmDelete: "Are you sure to delete this request history?",
    confirmBatchDelete: "Are you sure to delete {n} selected records?",
    confirmClearHistory:
      "Are you sure to clear all request history? This action cannot be undone.",
    clearNotImplemented:
      "Clear function is not implemented yet, please use batch delete",
  ...
  environment: {
    ...
    scopeHelp:
      "Global environments apply to all projects, local environments only apply to the associated project",
  ...
  report: {
    ...
    selectExecutionTip:
      'Please select a test execution record from the table below, then click "Generate & View Report" to generate and view the detailed test report',
    status: {
      pending: "Pending",
      running: "Running",
      completed: "Completed",
  ...
  component: {
    ...
    historyTable: {
      ...
      resultPassed: "Passed",
      resultFailed: "Failed",
      resultNoAssertion: "No Assertion",
      responseTime: "Response Time",
      environment: "Environment",
      noEnvironment: "No environment",
      executor: "Executor",
  ...
  messages: {
    ...
    warning: {
      ...
      websocketNotSupported:
        "WebSocket interfaces cannot be executed directly here, please use a dedicated WebSocket testing tool",
