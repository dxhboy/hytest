export default {
  project: {
    ...
    projectNameLength:
      "Project name length must be between 2 and 200 characters",
  ...
  home: {
    ...
    aiCaseGenerationDesc:
      "Intelligently analyze requirements, auto-generate test cases",
    ...
    aiEvaluatorDesc:
      "Professional software testing Q&A based on evaluator knowledge base",
    configCenter: "Configuration Center",
    configCenterDesc:
      "System environment, AI model and notification configuration",
