export default {
  requirementAnalysis: {
    ...
    subtitle:
      "AI will generate high-quality test cases based on requirement descriptions or documents",

    // Output Mode
    outputModeTitle: "📤 Output Mode Settings",
    outputModeDesc:
      "Select the output method for test case generation (applies to both manual input and document upload)",
    realtimeStream: "⚡ Real-time Stream",
    realtimeStreamDesc:
      "Display character by character, smooth experience, suitable for large requirement documents",
    completeOutput: "📄 Complete Output",
    completeOutputDesc:
      "Display all at once after completion, suitable for simple requirements",
    ...
    descriptionPlaceholder:
      "Describe your requirement in detail, including features, scenarios, business flows, etc.",
    ...
    streamConnectionInterrupted:
      "Stream connection interrupted, switching to polling mode",
  ...
  generatedTestCases: {
    ...
    batchDeleteConfirm:
      "Are you sure to delete {count} selected tasks? This cannot be undone.",
  ...
  promptConfig: {
    ...
    noConfigsHint:
      "Add prompt configurations to customize AI behavior and output format",
    emptyHint:
      "Add prompt configurations to customize AI behavior and output format",
  ...
  generationConfig: {
    ...
    subtitle:
      "Configure default behavior and automation flow for test case generation",
    description:
      "Configure default behavior and automation flow for test case generation",
    ...
    emptyDescription:
      "Please add generation behavior config to control default behavior of test case generation",
    ...
    enableHint:
      "Note: Only one config can be enabled. Enabling this will automatically disable other configs",
    ...
    completeOutput: "📄 Complete Output",
    outputModeHint:
      "Real-time Stream: Display character by character; Complete Output: Display all at once after completion",

    // Automation
    automationSettings: "🤖 Automation Process Config",
    enableAutoReview: "Enable AI Review & Improve",
    autoReviewHint:
      "Automatically perform AI review after generation and improve test cases based on review feedback",

    // Timeout
    timeoutSettingsLabel: "⏱️ Timeout Settings",
    reviewTimeoutLabel: "Review & Improve Timeout (seconds)",
    timeoutHint:
      "Total timeout for AI review and improvement (Recommended: 120s for small docs, 600-1800s for large docs, up to 3600s for very large docs)",
  ...
  taskDetail: {
    ...
    confirmDiscard:
      "Are you sure to discard {count} selected test cases? This cannot be undone.",
    ...
    confirmDiscardSingle:
      'Are you sure to discard test case "{scenario}"? This cannot be undone.',
