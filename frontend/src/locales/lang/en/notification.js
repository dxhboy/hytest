export default {
  ...
  placeholders: {
    ...
    dingtalkSecret: "Enter robot signature key (optional)",
  },

  // Hints
  hints: {
    feishuWebhook:
      "Feishu bot Webhook URL format: https://open.feishu.cn/open-apis/bot/v2/hook/...",
    wechatWebhook:
      "WeCom bot Webhook URL format: https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...",
    dingtalkWebhook:
      "DingTalk bot Webhook URL format: https://oapi.dingtalk.com/robot/send?access_token=...",
    dingtalkSecret:
      'robot signature key for security verification. Fill in this field if the bot has enabled "Sign" security settings.',
  },
  ...
  messages: {
    ...
    notFoundCreating:
      "No existing Webhook configuration found, creating new configuration",
    created: "created",
    updated: "updated",
  },
