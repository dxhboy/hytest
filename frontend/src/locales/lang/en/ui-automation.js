export default {
  ...
  dashboard: {
    ...
    elementLocationDesc:
      "Supports multiple locator strategies including ID, CSS Selector, XPath, etc. for precise element capture.",
    dualEngine: "Dual Engine",
    dualEngineDesc: "Supports Playwright + Selenium dual engine drivers",
    multiBrowser: "Multi-Browser",
    multiBrowserDesc:
      "Freely choose from Chrome, Safari, Edge, Firefox and more browsers, with headed and headless mode support.",
    fullNotification: "Full Notifications",
    fullNotificationDesc:
      "Configure email, Feishu, WeCom, DingTalk and other robot notifications to receive test results anywhere.",
    scriptRecording: "Script Recording",
    scriptRecordingDesc:
      "Visual script recording for quick test script generation, lowering the coding barrier.",
    autoExecution: "Auto Execution",
    autoExecutionDesc:
      "Supports manual trigger and scheduled execution, integrates with CI/CD for continuous testing.",
    // Time format
    justNow: "Just now",
  ...
  nav: {
    ...
    subtitle:
      "Automated testing solution to improve testing efficiency and quality",
    dashboard: "Dashboard",
    projects: "Projects",
    elements: "Elements",
  ...
  element: {
    ...
    forceActionTip:
      "Enable this option to force action on visibility:hidden elements",
    ...
    emptyElementTip:
      "Select an element to view details, or click the green button above to create a new element",
    ...
    messages: {
      ...
      confirmDeleteNode:
        'Are you sure to delete "{name}"? This action cannot be undone.',
  ...
  execution: {
    ...
    messages: {
      ...
      rerunCompleteWithFailure:
        "Test case execution completed with step failures",
  ...
  report: {
    ...
    messages: {
      ...
      deleteConfirm:
        'Are you sure to delete report "{name}"? This action cannot be undone.',
  ...
  ai: {
    ...
    off: "Off",
    gifTip:
      "When enabled, the execution process will be recorded as a GIF file and saved to ai_agent_history directory",
    startExecution: "Start Execution",
    stopExecution: "Stop Execution",
    saveAsCase: "Save as Case",
    tip: "Tips",
    tipContent1:
      'AI mode uses models from "Config Center - AI Mode Config" (please add models if not configured).',
    tipContent2:
      "Supports Chinese and English task descriptions. More detailed descriptions yield better results.",
    executionLogs: "Execution Logs",
    noLogs: "No execution logs",
  ...
  notification: {
    ...
    configs: {
      ...
      signatureSecretPlaceholder:
        "Please enter robot signature secret (optional)",
      signatureSecretHint:
        'robot signature secret for security verification. Fill this if the robot has enabled "Sign" security setting.',
      // Tab labels
      ...
      feishuUrlHint:
        "Feishu Webhook URL format: https://open.feishu.cn/open-apis/bot/v2/hook/...",
      wechatBotNamePlaceholder: "Please enter WeCom robot name",
      wechatUrlHint:
        "WeCom Webhook URL format: https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=...",
      dingtalkBotNamePlaceholder: "Please enter DingTalk robot name",
      dingtalkUrlHint:
        "DingTalk Webhook URL format: https://oapi.dingtalk.com/robot/send?access_token=...",
      // Save buttons
      ...
      messages: {
        ...
        noExistingConfig:
          "No existing Webhook config found, will create new config",
  ...
  scriptEditor: {
    ...
    language: "Language",
    editorPlaceholder:
      "Enter script code or click the + button in the element library to auto-insert code...",
    messages: {
      loadProjectsFailed: "Failed to load projects",
      loadElementTreeFailed: "Failed to load element tree",
      elementsLoaded: "Loaded {count} elements",
  ...
  pageObject: {
    ...
    rules: {
      ...
      classNamePattern:
        "Class name must start with uppercase letter and contain only letters and numbers",
      elementRequired: "Please select an element",
      methodNameRequired: "Please enter method name",
      methodNamePattern:
        "Method name can only contain letters, numbers, and underscores, and cannot start with a number",
    },
    messages: {
      loadProjectsFailed: "Failed to load projects",
      ...
      deletePageObjectConfirm:
        "Are you sure to delete this page object? This action cannot be undone.",
      confirmDelete: "Confirm Delete",
  ...
  script: {
    ...
    messages: {
      ...
      deleteConfirm:
        'Are you sure to delete script "{name}"? This action cannot be undone.',
      confirmDelete: "Confirm Delete",
      deleteSuccess: "Deleted successfully",
      deleteFailed: "Failed to delete",
    },
  ...
  testCase: {
    ...
    inputPlaceholder:
      "Enter content, supports variables like '{random_phone()}'",
