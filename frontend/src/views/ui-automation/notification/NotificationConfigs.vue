  ...
  <div class="notification-configs-container">
    ...
    <div class="content-wrapper">
      <el-tabs v-model="activeTab" class="notification-tabs">
        <!-- 飞书机器人Tab -->
        <el-tab-pane
          :label="$t('uiAutomation.notification.configs.feishuBot')"
          name="feishu"
        >
            ...
            <div class="config-section">
              ...
              >
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item
                      :label="$t('uiAutomation.notification.configs.botName')"
                    >
                      <el-input
                        v-model="webhookBots.feishu.name"
                        :placeholder="
                          $t(
                            'uiAutomation.notification.configs.feishuBotNamePlaceholder',
                          )
                        "
                      />
                    </el-form-item>
                  ...
                  <el-col :span="12">
                    <el-form-item
                      :label="$t('uiAutomation.notification.configs.enable')"
                    >
                  ...
                  <el-col :span="24">
                    <el-form-item
                      :label="
                        $t('uiAutomation.notification.configs.webhookUrl')
                      "
                    >
                      <el-input
                        ...
                        :placeholder="
                          $t(
                            'uiAutomation.notification.configs.webhookPlaceholder',
                          )
                        "
                      />
                  ...
                  <el-col :span="24">
                    <el-form-item
                      :label="
                        $t('uiAutomation.notification.configs.signatureSecret')
                      "
                    >
                      <el-input
                        v-model="webhookBots.feishu.secret"
                        :placeholder="
                          $t(
                            'uiAutomation.notification.configs.signatureSecretPlaceholder',
                          )
                        "
                        type="password"
                        show-password
                      ...
                      <div class="form-item-hint">
                        {{
                          $t(
                            "uiAutomation.notification.configs.signatureSecretHint",
                          )
                        }}
                      </div>
                    </el-form-item>
                  ...
                  <el-col :span="24">
                    <el-form-item
                      :label="
                        $t('uiAutomation.notification.configs.businessType')
                      "
                    >
                      <el-checkbox
                        v-model="webhookBots.feishu.enable_ui_automation"
                        >{{
                          $t(
                            "uiAutomation.notification.configs.uiAutomationTest",
                          )
                        }}</el-checkbox
                      >
                      <el-checkbox
                        v-model="webhookBots.feishu.enable_api_testing"
                        >{{
                          $t("uiAutomation.notification.configs.apiTest")
                        }}</el-checkbox
                      >
                    </el-form-item>
                  </el-col>
        ...
        <!-- 企业微信机器人Tab -->
        <el-tab-pane
          :label="$t('uiAutomation.notification.configs.wechatBot')"
          name="wechat"
        >
          <div class="tab-content">
            <div class="config-section">
              ...
              >
                <el-row :gutter="20">
                  <el-col :span="12">
                    ...
                    >
                      <el-input
                        ...
                        :placeholder="
                          $t(
                            'uiAutomation.notification.configs.wechatBotNamePlaceholder',
                          )
                        "
                      />
                    </el-form-item>
                  ...
                  <el-col :span="24">
                    ...
                    >
                      <el-checkbox
                        v-model="webhookBots.wechat.enable_ui_automation"
                        >{{
                          $t(
                            "uiAutomation.notification.configs.uiAutomationTest",
                          )
                      ...
                      >
                      <el-checkbox
                        v-model="webhookBots.wechat.enable_api_testing"
                        >{{
                          $t("uiAutomation.notification.configs.apiTest")
                        }}</el-checkbox
                      >
        ...
        <!-- 钉钉机器人Tab -->
        <el-tab-pane
          :label="$t('uiAutomation.notification.configs.dingtalkBot')"
          name="dingtalk"
        >
          <div class="tab-content">
            <div class="config-section">
              ...
              >
                <el-row :gutter="20">
                  <el-col :span="12">
                    ...
                    >
                      <el-input
                        ...
                        :placeholder="
                          $t(
                            'uiAutomation.notification.configs.dingtalkBotNamePlaceholder',
                          )
                        "
                      />
                    </el-form-item>
                  ...
                  <el-col :span="24">
                    ...
                    >
                      ...
                      <div class="form-item-hint">
                        {{
                          $t(
                            "uiAutomation.notification.configs.dingtalkUrlHint",
                          )
                        }}
                      </div>
                    </el-form-item>
                  ...
                  <el-col :span="24">
                    ...
                    >
                      <el-checkbox
                        v-model="webhookBots.dingtalk.enable_ui_automation"
                        >{{
                          $t(
                            "uiAutomation.notification.configs.uiAutomationTest",
                          )
                      ...
                      >
                      <el-checkbox
                        v-model="webhookBots.dingtalk.enable_api_testing"
                        >{{
                          $t("uiAutomation.notification.configs.apiTest")
                        }}</el-checkbox
                      >
  ...
  setup() {
    ...
    const saveWebhookBot = async (botType) => {
      ...
      try {
        ...
        try {
          ...
          console.log(
            t("uiAutomation.notification.configs.messages.noExistingConfig"),
          );
        }
        ...
        if (webhookConfigId) {
          ...
          const configResponse = await getUnifiedNotificationConfigs({
            config_type: configType,
          });
          ...
          // 飞书和钉钉机器人需要额外保存secret字段
          if (
            (botType === "dingtalk" || botType === "feishu") &&
            botConfig.secret
          ) {
          ...
          requestData = {
            name:
              existingConfig.name ||
              `${botDisplayName}${t("uiAutomation.notification.configs.title")}`,
            config_type: configType,
          ...
          const successMsgKey =
            botType === "feishu"
              ...
              : botType === "wechat"
                ? "wechatUpdateSuccess"
                : "dingtalkUpdateSuccess";
          ElMessage.success(
            t(`uiAutomation.notification.configs.messages.${successMsgKey}`),
          );
        } else {
          // 创建新配置
          const botData = {
        ...
        const failedMsgKey =
          botType === "feishu"
            ...
            : botType === "wechat"
              ...
              : "dingtalkSaveFailed";
        ElMessage.error(
          t(`uiAutomation.notification.configs.messages.${failedMsgKey}`) +
            ": " +
      ...
      try {
        ...
        if (response.data.results && response.data.results.length > 0) {
          ...
          if (config.webhook_bots && config.webhook_bots[botType]) {
            ...
            webhookBots[botType].enable_ui_automation =
              bot.enable_ui_automation !== false;
            webhookBots[botType].enable_api_testing =
              bot.enable_api_testing !== false;

            // 飞书和钉钉机器人需要额外读取secret字段
            if (
              (botType === "dingtalk" || botType === "feishu") &&
              bot.secret
            ) {
        ...
        console.error(
          t("uiAutomation.notification.configs.messages.getConfigFailed"),
          error,
        );
      }
    };
    ...
    const fetchAllWebhookConfigs = async () => {
      try {
        ...
        console.error(
          t("uiAutomation.notification.configs.messages.getAllConfigFailed"),
          error,
        );
      }
    };
