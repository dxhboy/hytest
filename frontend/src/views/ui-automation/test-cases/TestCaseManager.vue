<template>
  <div class="test-case-manager">
          ...
          >
            <div class="case-header">
              <div class="case-info">
                ...
                <p class="case-description">
                  {{
                    ...
                    t("uiAutomation.testCase.noDescription")
                  }}
                </p>
              </div>
              <div class="case-actions">
                <el-button
                  size="small"
                  text
                  @click.stop="runTestCase(testCase)"
                >
                ...
                <el-button
                  size="small"
                  text
                  @click.stop="copyTestCase(testCase)"
                >
            ...
            <div class="case-meta">
              ...
              <span class="step-count"
                ...
                {{ t("uiAutomation.testCase.stepsCount") }}</span
              >
              <span class="update-time">{{
                formatTime(testCase.updated_at)
              }}</span>
            </div>
          </div>
        </div>
          ...
          <div class="detail-header">
            ...
            <div class="detail-actions">
              ...
              <el-select
                ...
                :placeholder="t('uiAutomation.testCase.selectEngine')"
                size="small"
              ...
              <el-select
                ...
                :placeholder="t('uiAutomation.testCase.selectBrowser')"
                size="small"
              ...
              >
                <el-option
                  :label="t('uiAutomation.testCase.headedMode')"
                  :value="false"
                />
                <el-option
                  :label="t('uiAutomation.testCase.headlessMode')"
                  :value="true"
                />
              </el-select>
              <el-button
              ...
              >
                <el-icon
                  ><component :is="showSteps ? 'View' : 'Edit'"
                /></el-icon>
                {{
                  showSteps
                    ? t("uiAutomation.testCase.viewResult")
                    : t("uiAutomation.testCase.editSteps")
                }}
              </el-button>
              <el-button
                size="small"
          ...
          <div class="steps-container" v-show="showSteps">
            <div class="steps-header">
              ...
              <el-button size="small" text @click="expandAllSteps">
                {{
                  allStepsExpanded
                    ? t("uiAutomation.testCase.foldAll")
                    : t("uiAutomation.testCase.expandAll")
                }}
              </el-button>
            </div>
                  ...
                  <template #item="{ element, index }">
                    ...
                    >
                      <div class="step-header">
                        <div class="step-left">
                          ...
                          <el-select
                            ...
                            :placeholder="
                              t('uiAutomation.testCase.selectAction')
                            "
                            size="small"
                            style="width: 120px"
                          ...
                          >
                            <el-option
                              :label="t('uiAutomation.testCase.actionClick')"
                              value="click"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionFill')"
                              value="fill"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionGetText')"
                              value="getText"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionWaitFor')"
                              value="waitFor"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionHover')"
                              value="hover"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionScroll')"
                              value="scroll"
                            />
                            <el-option
                              :label="
                                t('uiAutomation.testCase.actionScreenshot')
                              "
                              value="screenshot"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionAssert')"
                              value="assert"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.actionWait')"
                              value="wait"
                            />
                            <el-option
                              :label="
                                t('uiAutomation.testCase.actionSwitchTab')
                              "
                              value="switchTab"
                            />
                          </el-select>
                        ...
                        <div class="step-right">
                          ...
                          >
                            <el-icon>
                              <component
                                :is="element.expanded ? 'ArrowUp' : 'ArrowDown'"
                              />
                            </el-icon>
                          </el-button>
                          <el-button
                      ...
                      <div v-if="element.expanded" class="step-content">
                        <!-- 输入参数 -->
                        <div
                          v-if="needsInputValue(element.action_type)"
                          class="step-param"
                        >
                          <label>{{
                            t("uiAutomation.testCase.inputValue")
                          }}</label>
                          <div style="display: flex; gap: 5px; flex: 1">
                            <el-input
                              v-model="element.input_value"
                              :placeholder="
                                element.action_type === 'switchTab'
                                  ? t(
                                      'uiAutomation.testCase.switchTabPlaceholder',
                                    )
                                  : t('uiAutomation.testCase.inputPlaceholder')
                              "
                              size="small"
                            >
                              <template #append>
                                <el-button
                                  ...
                                  :title="
                                    t(
                                      'uiAutomation.testCase.referenceDataFactory',
                                    )
                                  "
                            ...
                            <el-tooltip
                              :content="
                                t('uiAutomation.testCase.insertVariable')
                              "
                              placement="top"
                            ...
                            >
                              <el-button
                                size="small"
                                @click="
                                  openVariableHelper(element, 'input_value')
                                "
                        ...
                        <!-- 等待时间 -->
                        <div
                          v-if="needsWaitTime(element.action_type)"
                          class="step-param"
                        >
                          <label>{{
                            t("uiAutomation.testCase.waitTime")
                          }}</label>
                          <el-input-number
                        ...
                        <!-- 断言参数 -->
                        <div
                          v-if="element.action_type === 'assert'"
                          class="step-param"
                        >
                          <label>{{
                            t("uiAutomation.testCase.assertType")
                          }}</label>
                          <el-select
                            v-model="element.assert_type"
                            size="small"
                            style="width: 150px"
                          >
                            <el-option
                              :label="
                                t('uiAutomation.testCase.assertTextContains')
                              "
                              value="textContains"
                            />
                            <el-option
                              :label="
                                t('uiAutomation.testCase.assertTextEquals')
                              "
                              value="textEquals"
                            />
                            <el-option
                              :label="
                                t('uiAutomation.testCase.assertIsVisible')
                              "
                              value="isVisible"
                            />
                            <el-option
                              :label="t('uiAutomation.testCase.assertExists')"
                              value="exists"
                            />
                            <el-option
                              :label="
                                t('uiAutomation.testCase.assertHasAttribute')
                              "
                              value="hasAttribute"
                            />
                          </el-select>
                          ...
                          >
                            <el-input
                              ...
                              :placeholder="
                                t('uiAutomation.testCase.expectedValue')
                              "
                              size="small"
                              style="flex: 1"
                            >
                            ...
                            >
                              <el-button
                                ...
                                @click="
                                  openVariableHelper(element, 'assert_value')
                                "
                                class="variable-helper-btn"
                              >
                                <el-icon><MagicStick /></el-icon>
                        ...
                        <div class="step-param">
                          <label>{{
                            t("uiAutomation.testCase.stepDescription")
                          }}</label>
                          <el-input
                            v-model="element.description"
                            :placeholder="
                              t('uiAutomation.testCase.stepDescPlaceholder')
                            "
                            size="small"
                          />
                        </div>
          ...
          >
              ...
              <el-tag :type="executionResult.success ? 'success' : 'danger'">
                {{
                  executionResult.success
                    ? t("uiAutomation.testCase.executionSuccess")
                    : t("uiAutomation.testCase.executionFailed")
                }}
              </el-tag>
            </div>
            <div class="result-content">
              <el-tabs v-model="resultActiveTab">
                <el-tab-pane
                  :label="t('uiAutomation.testCase.executionLogs')"
                  name="logs"
                >
                  <div class="logs-container">
                    ...
                    <el-empty
                      :description="t('uiAutomation.testCase.noLogs')"
                    />
                  </div>
                </el-tab-pane>
                <el-tab-pane
                  :label="t('uiAutomation.testCase.failedScreenshots')"
                  name="screenshots"
                  v-if="
                    ...
                    >
                      <div class="screenshot-wrapper">
                        ...
                        <div
                          ...
                          v-if="!screenshot.loaded"
                        >
                          <el-icon><Picture /></el-icon>
                          <span>{{
                            t("uiAutomation.testCase.loadingImage")
                          }}</span>
                        </div>
                        <div class="screenshot-error" v-if="screenshot.error">
                          <el-icon><Warning /></el-icon>
                          <span>{{
                            t("uiAutomation.testCase.imageLoadFailed")
                          }}</span>
                        </div>
                      ...
                      <div class="screenshot-info">
                        <p class="screenshot-description">
                          {{
                            ...
                            t("uiAutomation.testCase.screenshot") +
                              " " +
                              (index + 1)
                          }}
                        </p>
                        <p
                          class="screenshot-meta"
                          v-if="screenshot.step_number"
                        >
                          {{ t("uiAutomation.testCase.step") }}
                          {{ screenshot.step_number }}
                        </p>
                        <p class="screenshot-time" v-if="screenshot.timestamp">
                ...
                <el-tab-pane
                  :label="t('uiAutomation.testCase.errorInfo')"
                  name="errors"
                  v-if="
                    ...
                    >
                      ...
                      >
                        <div v-if="error.action_type" class="meta-item">
                          <span class="meta-label">{{
                            t("uiAutomation.testCase.operationType")
                          }}</span>
                      ...
                      >
                        <div class="details-header">
                          {{ t("uiAutomation.testCase.detailErrorInfo") }}
                        </div>
    ...
    <el-dialog
      ...
      :title="
        editingTestCase
          ? t('uiAutomation.testCase.editTestCase')
          : t('uiAutomation.testCase.createTestCase')
      "
    ...
    >
      <el-form :model="testCaseForm" label-width="100px">
        <el-form-item :label="t('uiAutomation.testCase.caseName')" required>
          <el-input
            ...
            :placeholder="t('uiAutomation.testCase.caseNamePlaceholder')"
          />
        </el-form-item>
        ...
        <el-form-item :label="t('uiAutomation.testCase.priority')">
          <el-select v-model="testCaseForm.priority" style="width: 100%">
            <el-option
              :label="t('uiAutomation.testCase.priorityHigh')"
              value="high"
            />
            <el-option
              :label="t('uiAutomation.testCase.priorityMedium')"
              value="medium"
            />
            <el-option
              :label="t('uiAutomation.testCase.priorityLow')"
              value="low"
            />
          </el-select>
        </el-form-item>
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="saveTestCaseForm">{{
    ...
    >
      <div v-if="currentScreenshot" class="screenshot-preview">
        <div class="preview-info">
          ...
          <p v-if="currentScreenshot.step_number">
            {{ t("uiAutomation.testCase.failedStep") }}:
            {{ t("uiAutomation.testCase.step") }}
            {{ currentScreenshot.step_number }}
          </p>
          <p v-if="currentScreenshot.timestamp">
            {{ t("uiAutomation.testCase.screenshotTime") }}:
        ...
        >
          <div style="height: 450px; overflow-y: auto; padding: 10px">
            ...
            >
              <el-table-column
                prop="name"
                :label="t('uiAutomation.testCase.functionName')"
                width="150"
              ...
              <el-table-column
                prop="syntax"
                :label="t('uiAutomation.testCase.syntax')"
                min-width="200"
                show-overflow-tooltip
              />
              <el-table-column
                prop="example"
                :label="t('uiAutomation.testCase.example')"
                min-width="200"
                show-overflow-tooltip
              />
              <el-table-column
...
const runTestCase = async (testCase) => {
  ...
  try {
    const modeText = headlessMode.value
      ? t("uiAutomation.testCase.runMode.headless")
      : t("uiAutomation.testCase.runMode.headed");
    ElMessage.info(
      t("uiAutomation.testCase.run.start", {
        engine: selectedEngine.value.toUpperCase(),
        browser: selectedBrowser.value.toUpperCase(),
        mode: modeText,
      }),
    );
    ...
    ElMessage.error(
      t("uiAutomation.testCase.run.failedWithMessage", {
        message: errorMessage,
      }),
    );
  } finally {
      ...
      variables: [
        {
          ...
          desc: t("uiAutomation.testCase.variable.randomInt.desc"),
          example: "${random_int(100, 999, 1)}",
        },
        {
          name: "random_float",
          syntax: "${random_float(min, max, precision, count)}",
          desc: t("uiAutomation.testCase.variable.randomFloat.desc"),
      ...
      variables: [
        {
          ...
          desc: t("uiAutomation.testCase.variable.randomString.desc"),
...
const variableCategoriesComputed = computed(() => {
  return variableCategories.value.length > 0
    ? variableCategories.value
    : [
        {
          label: t("uiAutomation.testCase.variableCategory.randomNumber"),
...
const openVariableHelper = (step, field) => {
  console.log(
    "TestCaseManager openVariableHelper 被调用, step:",
    step,
    "field:",
    field,
  );
  ...
  console.log(
    "variableCategories.value.length:",
    variableCategories.value.length,
  );
...
const handleDataFactorySelect = (record) => {
  ...
  if (record && record.output_data && step && field) {
    ...
    ElMessage.success(
      t("uiAutomation.testCase.messages.dataFactorySelected", {
...
const insertVariable = (variable) => {
  if (currentEditingStep.value && currentEditingField.value) {
    ...
    const currentValue =
      currentEditingStep.value[currentEditingField.value] || "";
    ...
    ElMessage.success(
      t("uiAutomation.testCase.messages.variableInserted", {
        name: variable.name,
      }),
    );
