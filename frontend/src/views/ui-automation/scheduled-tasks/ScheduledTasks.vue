  ...
  <div class="scheduled-tasks">
    ...
    <div class="filters">
      <el-row :gutter="20">
        <el-col :span="6">
          ...
          >
            <el-option
              :label="$t('uiAutomation.scheduledTask.taskTypes.testSuite')"
              value="TEST_SUITE"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.taskTypes.testCase')"
              value="TEST_CASE"
            />
          </el-select>
        </el-col>
        <el-col :span="6">
          ...
          >
            <el-option
              :label="$t('uiAutomation.scheduledTask.triggerTypes.cron')"
              value="CRON"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.triggerTypes.interval')"
              value="INTERVAL"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.triggerTypes.once')"
              value="ONCE"
            />
          </el-select>
        </el-col>
        <el-col :span="6">
          ...
          >
            <el-option
              :label="$t('uiAutomation.scheduledTask.statusTypes.active')"
              value="ACTIVE"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.statusTypes.paused')"
              value="PAUSED"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.statusTypes.completed')"
              value="COMPLETED"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.statusTypes.failed')"
              value="FAILED"
            />
          </el-select>
        </el-col>
    ...
    <div class="task-list">
      <el-table :data="tasks" v-loading="loading">
        <el-table-column
          prop="name"
          :label="$t('uiAutomation.scheduledTask.taskName')"
          min-width="200"
        />
        <el-table-column
          prop="task_type"
          :label="$t('uiAutomation.scheduledTask.taskType')"
          width="120"
        >
          <template #default="scope">
            <el-tag
              :type="
                scope.row.task_type === 'TEST_SUITE' ? 'success' : 'primary'
              "
            >
              {{
                scope.row.task_type === "TEST_SUITE"
                  ? $t("uiAutomation.scheduledTask.taskTypes.testSuiteShort")
                  : $t("uiAutomation.scheduledTask.taskTypes.testCaseShort")
              }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column
          ...
          :label="$t('uiAutomation.scheduledTask.notificationType')"
          width="130"
        >
          <template #default="scope">
            <el-tag
              ...
              "
              :type="
                getNotificationTypeTagType(scope.row.notification_type_display)
              "
              size="small"
            >
        ...
        <el-table-column
          prop="trigger_type"
          :label="$t('uiAutomation.scheduledTask.triggerType')"
          width="120"
        >
          <template #default="scope">
            <el-tag>
        ...
        <el-table-column
          prop="status"
          :label="$t('uiAutomation.scheduledTask.status')"
          width="100"
        >
          <template #default="scope">
            <el-tag
        ...
        <el-table-column
          prop="engine"
          :label="$t('uiAutomation.scheduledTask.executionEngine')"
          width="120"
        >
          <template #default="scope">
        ...
        <el-table-column
          prop="browser"
          :label="$t('uiAutomation.scheduledTask.browser')"
          width="100"
        >
          <template #default="scope">
        ...
        <el-table-column
          prop="next_run_time"
          :label="$t('uiAutomation.scheduledTask.nextRunTime')"
          width="180"
        >
          <template #default="scope">
        ...
        <el-table-column
          prop="last_run_time"
          :label="$t('uiAutomation.scheduledTask.lastRunTime')"
          width="180"
        >
          <template #default="scope">
        ...
        >
          <template #default="scope">
            <el-tag :type="scope.row.visibility === 'all' ? 'success' : 'info'" size="small">
              {{ scope.row.visibility === 'all' ? $t('uiAutomation.common.visibleAll') : $t('uiAutomation.common.visibleSelf') }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column
    ...
    <el-dialog
      ...
      :title="
        editingTask
          ? $t('uiAutomation.scheduledTask.editTask')
          : $t('uiAutomation.scheduledTask.createTask')
      "
      width="800px"
    ...
    >
      <el-form :model="taskForm" label-width="120px">
        ...
        >
          <el-input
            ...
            :placeholder="$t('uiAutomation.scheduledTask.taskNamePlaceholder')"
          />
        </el-form-item>
        ...
        <el-form-item :label="$t('uiAutomation.scheduledTask.taskDesc')">
          <el-input
            ...
            type="textarea"
            :placeholder="$t('uiAutomation.scheduledTask.taskDescPlaceholder')"
          />
        </el-form-item>

        <el-form-item
          :label="$t('uiAutomation.scheduledTask.relatedProject')"
          required
        >
          <el-select
            v-model="taskForm.project"
            :placeholder="$t('uiAutomation.scheduledTask.selectProject')"
        ...
        >
          ...
          >
            <el-radio value="TEST_SUITE">{{
              $t("uiAutomation.scheduledTask.taskTypes.testSuite")
            }}</el-radio>
            <el-radio value="TEST_CASE">{{
        ...
        <el-form-item
          v-if="taskForm.task_type === 'TEST_SUITE'"
          :label="$t('uiAutomation.scheduledTask.testSuite')"
          required
        >
          <el-select
            v-model="taskForm.test_suite"
            :placeholder="$t('uiAutomation.scheduledTask.selectSuite')"
          >
            <el-option
        ...
        <el-form-item
          v-if="taskForm.task_type === 'TEST_CASE'"
          :label="$t('uiAutomation.scheduledTask.testCase')"
          required
        >
          <el-select
        ...
        >
          <el-radio-group v-model="taskForm.trigger_type">
            <el-radio value="CRON">{{
              $t("uiAutomation.scheduledTask.triggerTypes.cron")
            }}</el-radio>
            <el-radio value="INTERVAL">{{
              $t("uiAutomation.scheduledTask.triggerTypes.interval")
            }}</el-radio>
            <el-radio value="ONCE">{{
              $t("uiAutomation.scheduledTask.triggerTypes.once")
            }}</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item
          ...
          :label="$t('uiAutomation.scheduledTask.cronExpression')"
          required
        >
          <el-input
            v-model="taskForm.cron_expression"
            :placeholder="$t('uiAutomation.scheduledTask.cronPlaceholder')"
          />
          <div class="cron-help">
            <el-tooltip raw-content placement="top">
              <template #content>
                <div style="line-height: 1.6; text-align: left">
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.format") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.minute") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.hour") }}
                  </div>
                  <div>{{ $t("uiAutomation.scheduledTask.cronHelp.day") }}</div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.month") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.week") }}
                  </div>
                  <div style="margin-top: 8px">
                    {{ $t("uiAutomation.scheduledTask.cronHelp.examples") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.everyDay") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.everyHour") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.everyMonday") }}
                  </div>
                  <div>
                    {{ $t("uiAutomation.scheduledTask.cronHelp.everyMonth") }}
                  </div>
                </div>
              </template>
              <span style="cursor: pointer; color: #409eff">{{
                $t("uiAutomation.scheduledTask.cronHelpLink")
              }}</span>
            </el-tooltip>
          </div>
        </el-form-item>
        ...
        <el-form-item
          ...
          :label="$t('uiAutomation.scheduledTask.intervalTime')"
          required
        >
          <el-input-number
          ...
          />
          <span class="unit">{{
            $t("uiAutomation.scheduledTask.intervalUnit")
          }}</span>
        </el-form-item>

        <el-form-item
          v-if="taskForm.trigger_type === 'ONCE'"
          :label="$t('uiAutomation.scheduledTask.executeTime')"
          required
        >
          <el-date-picker
        ...
        <el-form-item
          :label="$t('uiAutomation.scheduledTask.browserType')"
          required
        >
          <el-select
            v-model="taskForm.browser"
            :placeholder="$t('uiAutomation.scheduledTask.selectBrowser')"
          >
        ...
        <el-form-item :label="$t('uiAutomation.scheduledTask.runMode')">
          <el-checkbox v-model="taskForm.headless">{{
            $t("uiAutomation.scheduledTask.headlessMode")
          }}</el-checkbox>
        </el-form-item>
        ...
        >
          <el-checkbox v-model="taskForm.notify_on_success">{{
            $t("uiAutomation.scheduledTask.notifyOnSuccess")
          }}</el-checkbox>
          <el-checkbox v-model="taskForm.notify_on_failure">{{
            $t("uiAutomation.scheduledTask.notifyOnFailure")
          }}</el-checkbox>
        </el-form-item>
        ...
        >
          <el-select
            v-model="taskForm.notification_type"
            :placeholder="
              $t('uiAutomation.scheduledTask.selectNotificationType')
            "
          >
            <el-option
              :label="$t('uiAutomation.scheduledTask.notificationTypes.email')"
              value="email"
            />
            <el-option
              :label="
                $t('uiAutomation.scheduledTask.notificationTypes.webhook')
              "
              value="webhook"
            />
            <el-option
              :label="$t('uiAutomation.scheduledTask.notificationTypes.both')"
              value="both"
            />
          </el-select>
        </el-form-item>
        ...
        <el-form-item
          v-if="
            (taskForm.notify_on_success || taskForm.notify_on_failure) &&
            (taskForm.notification_type === 'email' ||
              taskForm.notification_type === 'both')
          "
          :label="$t('uiAutomation.scheduledTask.notifyEmails')"
        >
          <el-select
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="submitTaskForm" :loading="submitting">
          {{
            editingTask
              ? $t("uiAutomation.messages.success.update")
              : $t("uiAutomation.messages.success.create")
          }}
        </el-button>
      </template>
    </el-dialog>
  ...
  try {
    ...
    ElMessage.error(
      error.response?.data?.error ||
        ...
        (editingTask.value
          ? t("uiAutomation.scheduledTask.messages.updateFailed")
          : t("uiAutomation.scheduledTask.messages.createFailed")),
    );
  } finally {
...
const deleteTask = async (task) => {
  try {
    await ElMessageBox.confirm(
      t("uiAutomation.scheduledTask.messages.deleteConfirm"),
      t("uiAutomation.scheduledTask.messages.deleteConfirmTitle"),
      {
