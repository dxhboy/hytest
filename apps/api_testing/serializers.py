...
class ApiRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'post_request_script', 'assertions', 'collection', 'order', 'visibility',
            'skip_auth', 'created_by', 'created_at', 'updated_at'
        ]
        read_only_fields = ['created_at', 'updated_at']
...
class TestSuiteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'suite_requests', 'created_by', 'created_at', 'updated_at', 'visibility'
        ]
        read_only_fields = ['created_at', 'updated_at']
        ...
        if data.get('results') and isinstance(data['results'], list):
            for result in data['results']:
                if isinstance(result, dict):
                    # 确保断言结果存在
                    if 'assertions_results' not in result:
